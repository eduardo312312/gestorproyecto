...
<!--                 </li> -->
                <li class='level1'>
                    ...
                    <ul class="nav nav-third-level">
                    <li id="view-boxsales"><a href="sales" class="fa fa-file-text"> <span>Ficha de Inicio</span></a></li>
  ...
  <ul class="nav nav-third-level">
                ...
                <li class='level1'><a title="Compromisos" id="BordeSideMenu"  class='fa fa-calendar'> <span>CIERRE</span></a>
                   ...
                   <ul class="nav nav-third-level">
                        ...
                        <li id="view-order"><a class="fa fa-file-text" href="reportperformance"> <span>Ind. Desempeño Cronograma y Costo</span></a></li>
