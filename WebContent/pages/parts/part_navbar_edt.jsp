    ...
    <nav class="navbar navbar-default">
        ...
        <div class="container-fluid">
          <div class="navbar-header">
           <a style="margin-top: 14px !important;" class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-sitemap">
            </i> </a>
...
<!--               <li class="active"><a href="#">Home</a></li> -->
              <li><a href="index">Volver al Menu principal</a></li>
