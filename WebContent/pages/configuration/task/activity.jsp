...
<head>
    ...
    <script src="resources/js/angular/configuration/task/ActivityController.js"></script>
...
<body ng-controller="ActivityController">
    ...
    <!-- aca inicia el header-->
       ...
       <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
            <button  class="btn btn-primary dim"  ng-click="new_register()" data-toggle="modal" data-target="#myModal" href="javascript:void(0);" >Crear Actividad</button>
			</div>
			 <div class="row">
