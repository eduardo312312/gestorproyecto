...
<head>
    ...
    <title>ADMINISTRACION DE FASES</title>
    ...
    <!-- aca inicia el header-->
       ...
       <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="centrar_titulo">
                <h5>Registro de Fases</h5>
                
            </div>
            <div class="ibox-content">
            <div class="row">
            <button  class="btn btn-primary dim"  ng-click="new_register()" data-toggle="modal" data-target="#myModal" href="javascript:void(0);" >Crear Fase</button>
			</div>
			 <div class="row">
