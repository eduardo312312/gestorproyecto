...
<head>
    ...
    <script src="resources/js/angular/project/meetingrecord/MeetingRecordController.js"></script>
...
$(function(){
	...
	uploadWidget=$("#fileuploader").uploadFile({
		allowedTypes:"pdf" ,
		url:"change/uploadmeet?${_csrf.parameterName}=${_csrf.token}",
		multiple:false,
		dragDrop:true,
...
<body ng-controller="MeetingRecordController">
    ...
    <!-- aca inicia el header-->
       ...
       <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="centrar_titulo">
                <h5>Registro de Actas de Reuniones</h5>
...
<!--   			      <input id='product_id' type='hidden' ng-model='product.id' value='{{product.id}}' /> -->
  			     			  ...
  			     			  <div class="form-group"><label class="col-sm-3 control-label" >Reunion:</label>

                                    <div class="col-sm-9"><input type="text" class="form-control" ng-model="meet.meetname" /></div>
                                </div>
                                <div class="form-group"><label class="col-sm-3 control-label" >Descripcion:</label>

                                    <div class="col-sm-9"><input type="text" class="form-control" ng-model="meet.description" /></div>
                                </div>
                                <div class="form-group"><label class="col-sm-3 control-label" >Lugar:</label>

                                    <div class="col-sm-9"><input type="text" class="form-control" ng-model="meet.location" />                                    
                                    
                                    </div>
                                </div>			
  			     				   		
                                   <div class="form-group"><label class="col-sm-3 control-label" >Facilitador:</label>
...
<!--                                     <div class="col-md-9">                 -->
                                    ...
                                    <div class="col-sm-9"><input style={{stylenew}} id="employeeeee2" type="text" class="form-control" ng-change="select_responsable()" ng-model="meet.businesssubjectname" list="employees_list2"  ></div>
<!--                                  </div>    -->
<!--                                 </div>  -->
                                ...
                                <div class="form-group"><label class="col-sm-3 control-label" >Razon</label>
                                    ...
                                    <div class="col-sm-9">
                                    <select style={{stylenew}}   class="form-control m-b" ng-model="meet.comment">
<!--                                               <option></option> -->
                                 ...
                                 <div  class="form-group"><label ng-show="!newreg" class="col-sm-3 control-label" >Adjuntar</label>
                                    ...
                                    <div class="col-sm-9">
  			     					 ...
  			     					 <input id='meet_id' type='hidden' ng-model='change.id' value='{{meet.id}}' />
  			     					 <a ng-show="!newreg"  href="resources/pdf/meet/{{meet.id}}.pdf" target="_blank">Abrir</a>
  			     					  </div>
